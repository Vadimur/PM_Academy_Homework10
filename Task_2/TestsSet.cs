    ...
    public class TestsSet
    {
        ...
        public async Task RunAll()
        {
            ...
            Task[] tasks =
            {
                ...
                Test_FindPrimeNumbersInRange_InvalidNumericQueryParameter(),
                Test_FindPrimeNumbersInRange_InvalidQueryParameter(), // not checking response body, because it is generated by ApiController attribute
                Test_FindPrimeNumbersInRange_WithoutQueryParameters()
            };
        ...
        {
            await TestBase(3, "/primes/4", 404, "Requested number is not prime");
        }
        ...
        public async Task Test_FindPrimeNumbersInRange_InvalidNumericQueryParameter()
        {
            await TestBase(6, "/primes?from=1", 400, "Response status code: 400 | Bad Request | Both parameters 'from' and 'to' should be specified in query");
        }

        public async Task Test_FindPrimeNumbersInRange_InvalidQueryParameter()
        {
            await TestBase(7, "/primes?from=0&to=asgasd", 400);
        }

        public async Task Test_FindPrimeNumbersInRange_WithoutQueryParameters()
        {
            await TestBase(8, "/primes", 400, "Response status code: 400 | Bad Request | Both parameters 'from' and 'to' should be specified in query");
        }
            ...
            string expectedResponseBody = null)
        {
            ...
            {
                builder.AppendLine("Not checking response body, because it is automatically generated by ApiController attribute");
            }
